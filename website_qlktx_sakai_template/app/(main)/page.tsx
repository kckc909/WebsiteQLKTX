    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <div className="w-full">
                {/* <Image src="/custom/banner_home.jpg" alt="Banner" width={1920} height={500} className="w-full object-cover" /> */}
            </div>
            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {/* <Image src="/custom/hoatdong1.jpg" alt="HĐ 1" width={400} height={300} className="rounded-xl" />
                    <Image src="/custom/hoatdong2.jpg" alt="HĐ 2" width={400} height={300} className="rounded-xl" />
                    <Image src="/custom/hoatdong3.jpg" alt="HĐ 3" width={400} height={300} className="rounded-xl" />
                    <Image src="/custom/hoatdong4.jpg" alt="HĐ 4" width={400} height={300} className="rounded-xl" /> */}
                </div>
            </div>
        </div>
    )
